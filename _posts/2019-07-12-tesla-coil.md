...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/Singingteslacoil.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_171223.jpg" class="img-fluid rounded z-depth-1" caption="A cubical box, contains today's focus" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_171319.jpg" class="img-fluid rounded z-depth-1" caption="Content of the box" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_171758.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_172156.jpg" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_172401.jpg" class="img-fluid rounded z-depth-1" caption="Cut the exceed pins" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_172716.jpg" class="img-fluid rounded z-depth-1" %}

Continue with third shortest components, which is DC connector, Audio Jack connector and a capacitor.

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_173215.jpg" class="img-fluid rounded z-depth-1" %}

The next one would be two transistors, one 80NF70 N-channel MOSFET and one NPN transistor BD243.

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_173610.jpg" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_173630.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_173726.jpg" class="img-fluid rounded z-depth-1" caption="The thermal paste" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_173834.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_174019_01.jpg" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_174245.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_181143.jpg" class="img-fluid rounded z-depth-1" caption="Secondary coil mounted." %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_181150.jpg" class="img-fluid rounded z-depth-1" caption="The red wire is primary coil" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_181619.jpg" class="img-fluid rounded z-depth-1" caption="Final result!" %}

{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/IMG_20190710_212605.jpg" class="img-fluid rounded z-depth-1" caption="The arc is sparking when the current is on." %}
...
{% include figure.liquid loading="eager" max-width=640 width=560 path="assets/img/120719/Schematic_teslacoil_Sheet-1_20190712152617.png" class="img-fluid rounded z-depth-1" caption="Circuit schematics of the coil" %}
...
{% include video.liquid path="https://www.youtube.com/embed/dhfhIUJyrPA" class="rounded z-depth-1" %}
